...
public class IntegerAPI {
    ...
    public void toStringWithRadix() {
        // Integer to string number with specific radix, return value may have minus sign
        Assert.assertEquals("10", Integer.toString(16, 16));
        Assert.assertEquals("-10", Integer.toString(-16, 16));
        Assert.assertEquals("1000", Integer.toString(8, 2));
        Assert.assertEquals("-1000", Integer.toString(-8, 2));
        Assert.assertEquals("10", Integer.toString(10, 9999999));// 10 radix
    }
    ...
    public void toOctalString() {
        // 10 radix number to unsigned 8 radix
    ...
    public void toBinaryString() {
        // 10 radix number to unsigned 2 radix
    ...
    public void toUnsignedString10() {
        // 10 radix number to unsigned 10 number radix
    ...
    public void parseInt() {
        // 2 radix sign string number to 10 radix
    ...
    public void parseUnsignedInt() {
        // 10 radix string unsigned number to 10 radix number
    ...
    @Test
    public void valueOf() {
        // radix sign number string to 10 radix
